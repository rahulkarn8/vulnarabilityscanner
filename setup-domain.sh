...
echo ""
echo ""
echo "❓ Do you want to map the backend to a subdomain? (e.g., api.stratum.daifend.ai)"
echo "   This is optional - the frontend can use the backend's Cloud Run URL"
echo ""
...
echo ""
echo "📌 Optional: To map backend to api.stratum.daifend.ai, run:"
